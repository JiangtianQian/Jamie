...
public class test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        parameters.put("queryFilePath", "/Users/kaka/Documents/CMU/searchengine/hw2/QryEval/query.txt");
        parameters.put("trecEvalOutputLength", "100");
        parameters.put("retrievalAlgorithm", "BM25");
        parameters.put("BM25:b", "0.75");
        parameters.put("BM25:k_3", "0");
        for (double i = 1.2; i < 2.0; i = i + 0.1){
            String tmp ="/Users/kaka/Documents/CMU/searchengine/hw2/QryEval/trec_eval"+i;
            parameters.put("trecEvalOutputPath", "tmp");
            parameters.put("BM25:k_1", ""+i);
